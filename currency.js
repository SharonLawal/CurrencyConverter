const selection = document.querySelectorAll(".selection-box select");
...
for (let i = 0; i < selection.length; i++) {
    for(let currency_code in country_list){
        ...
        selection[i].insertAdjacentHTML("beforeend", optionTag);
    }
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/0e0c002de5507f37c0d236a8/latest/${fromCurrency.value}`;
